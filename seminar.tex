...
Even though the hybrid method shows the clear benefits over the individual methods, it still suffers from the limitations of the concolic exection. The discovery of new path of coverage depends on the capacity of the constraint solver and the path-explosion problem in exhaustive local search. Thus, this method may not achieve 100 percent coverage but it can improve the coverage considerably.
